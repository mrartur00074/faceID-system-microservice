...
admin_kb = InlineKeyboardMarkup(
    inline_keyboard=[
        ...
        [
            InlineKeyboardButton(text="📄 Посмотреть группы", callback_data="view_groups"),
            InlineKeyboardButton(text="📄 Посмотреть учителей", callback_data="list_teachers")
        ],
        [
        ...
        [
            ...
            InlineKeyboardButton(text="Удалить учителя", callback_data="remove_teacher")
        ],
        [
            InlineKeyboardButton(text="Выбор группы для логов", callback_data="set_log_group"),
        ]
    ]
)
